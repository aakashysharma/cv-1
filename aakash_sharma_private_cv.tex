...
\begin{EntriesTable}
	\Year{2021-2022} &
	60 CP Master Thesis Supervision : Sivert Johansen. \href{thesis link}{\textit{Gurret: Decentralized data management using subscription-based file attribute propagation}}
	\\
	\Year{INF-3200} &
...
\textbf{WebAnno} 3.0 -- \href{https://webanno.github.io/webanno/}{WebAnno on GitHub}
\\
...
English (\textit{Fluent}),  German (\textit{Basic}), Hindi (\textit{Native})
