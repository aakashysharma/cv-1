...
\begin{EntriesTable}
%    \Year{2021}  &
%    \textbf{PhD in Computer Science}, University of Troms{\o}, Norway
%    \newline
%    Thesis: \textit{Privacy-Preserving Analytics on Multimedia Data}
%    \\
    \Year{2017}  &
    \textbf{MSc in Distributed Software Systems}, TU Darmstadt, Germany
    \newline
    Thesis: \textit{Differential Map Updates for Highly Automated Driving and Enhanced Driver Assistance Services}
    \\
    \Year{2009}  &
    \textbf{BEng in Information Technology}, Sant Gadge Baba Amravati University, India
    \\
    %\Year{2008}  &
...
\begin{EntriesTable}
    \Duration{2017}{}  &
    \textbf{PhD Stipendiat},
    University of Troms{\o}, Norway
    \\
    \Duration{2016}{2017}  &
    \textbf{Werkstudent - Business Intelligence System},
...
\Year{Submitted}  &
    ...
    \emph{Communications in Computer and Information Science, Springer}
