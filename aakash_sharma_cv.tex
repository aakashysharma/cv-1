...
\begin{EntriesTable}
    ...
    Polytech Dominlens GmbH, Germany
    \\
    \Duration{2015}{2016}  &
...
\begin{EntriesTable}
%	\Year{\textit{2019}}  &
%	\textbf{Aakash Sharma}, H{\aa}vard Johansen, Lars Brenna, Dag Johansen.
%	Privacy Perceptions in Image Based Dietary Assessment,
%	\emph{3$^{rd}$ International Workshop on SECurity and Privacy Requirements Engineering - SECPRE 2019}
...
\Year{\textit{2019}}  &
    ...
    \emph{Communications in Computer and Information Science (CCIS), Springer, Cham}
   \DOI{10.1007/978-3-030-02907-4\_11}.
   \\
\Year{2017}  &
...
%	\\
	\Year{2018--2020} & \textbf{Member} ACM SIGOPS Social Media Team
    \\
    \Year{2020} & \textbf{Artifact Evaluation Committee} USENIX OSDI 
    \\
    ...
    \\
    \Year{2016} & \textbf{Student Volunteer} ISC High Performance%, Frankfurt, Germany 
\end{EntriesTable}
...
English (\textit{Fluent}), German (\textit{Basic}), Norwegian (\textit{Basic}), Hindi (\textit{Native})
%\TablePad
